...
function renderQuiz() {
    ...
    html += `
        <div class="mt-auto flex justify-end pb-4">
            ${!qState.isEvaluated ? `
                <button onclick="evaluateAnswer()" class="bg-navy-900 text-white px-8 py-3 rounded-lg font-semibold shadow hover:bg-navy-800 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2" ${!qState.selectedOption ? 'disabled' : ''}>
